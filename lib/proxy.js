    ...
    onRequestHandler(req, res) {
        ...
        next((request) => {
            ...
            connection.on('response', (connectionResponse) => {
                const response = {httpVersion: connectionResponse.httpVersion, statusCode: connectionResponse.statusCode, statusMessage: connectionResponse.statusCode, headers: connectionResponse.headers}
