...
const generateCaKeysAndCert = ({commonName='CA', serialNumber=generateSerialNumber(), keyLength=2048}={}) => {
...
const generateServerKeysAndCert = ({domain, caKeysAndCert, keyLength=2048}={}) => {
